    ...
    <>
      ...
      <div className={Styles.div2}>
        <div>
          ...
          <h1
            className={Styles.h1Tag}
            style={{ textAlign: "left", color: "rgb(142,192,56)" }}
          >
            It's a lifestyle!
          </h1>
      ...
      <div className={Styles.gray}>
        ...
        <div className={Styles.greenDiv}>
          <div className={Styles.innerGreenDiv}>
            ...
            <h1 className={Styles.h1Tag} style={{ fontSize: "50px" }}>
            ...
            <div className={Styles.innerGreenDiv2}>
              ...
              <div>
                <h1 className={Styles.h1Fonts} style={{ textAlign: "left" }}>
                  Weight Losse Meal Plan
                </h1>
                <h3 style={{ color: "rgb(142,192,56)", textAlign: "left" }}>
                  1200-1400 kcal
                </h3>
                <p className={Styles.pFonts} style={{ textAlign: "left" }}>
          ...
          <div className={Styles.overlayContent}>
            <div className={Styles.content}>
              <h1>
                ...
                <br />
                Get our
                <span style={{ color: "rgb(142,192,56)" }}>
                  {" "}
                  1 week trial plan
                </span>
              </h1>
      ...
      <div className={Styles.dietplans}>
        <div className={Styles.text}>
          ...
          <h2 style={{ marginTop: "-15px", color: "#292d35" }}>
      ...
      <div className={Styles.mailList}>
        <h1 style={{ fontSize: "50px", paddingTop: "60px" }}>
          Join our <span style={{ color: "white" }}>mailing list</span>
        </h1>
        <p className={Styles.pFonts}>
          {" "}
      ...
      <div className={Styles.recentArticleDiv}>
        <div className={Styles.recentImg1}>
          ...
          <p className={Styles.pFonts}>
            We’re excited to announce our collaboration with Nestle a+. Now you
            can get a Nestle a+ Grekyo with every breakfast meal! Wh …
          </p>
          <hr></hr>
        ...
        <div className={Styles.recentImg1}>
          ...
          <p className={Styles.pFonts}>
            ...
            surplus. Contrary to what most people think, it’s actually very har
            …
          </p>
          <hr></hr>
          <div className={Styles.details}>
