...
const SliderBox=()=> {
  ...
  useEffect(()=>{
   ...
   return(
       <div>
       <div>
           <button className={Styles.prev} onClick={prevSlide}><div className={Styles.prevBox}><i class="fas fa-arrow-left"></i></div></button>
    <button className={Styles.next} onClick={nextSlide}><div className={Styles.prevBox}><i class="fas fa-arrow-right"></i></div></button>
